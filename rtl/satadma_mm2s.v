...
//
// Purpose:	From the ZipCPU, a memory to stream DMA.  Reads values from
//		memory to generate a stream of data.
//
//	This is the memory component of the transmit sequence.  It reads
//	values from memory, and aligns them with an outgoing data stream.
//
