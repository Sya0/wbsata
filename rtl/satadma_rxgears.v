...
//
// Purpose:	From the ZipCPU's DMA implementation, a gearbox to pack
//		received data.  This is part of our alignment process.  Data
//	comes in (aligned), then gets packed here before going into the FIFO
//	to be written to the SATA device.  Here, we simply pack words prior
//	to stuffing them into the FIFO.
//
//
